...
namespace Practica5.Controllers
{
    public class Modulo1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Nombre,Celular,Email,Direccion")] Modulo1 modulo1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Nombre,Celular,Email,Direccion")] Modulo1 modulo1)
        {
            if (ModelState.IsValid)
            {
